 ...
 */
@WebServlet("/ShowAllQuestionMangerServlet")
public class ShowAllQuestionMangerServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowAllQuestionMangerServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dis=request.getRequestDispatcher("showAllQuestionManger.jsp");
