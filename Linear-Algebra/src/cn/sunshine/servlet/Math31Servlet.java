...
/**
 * Servlet implementation class Math31Servlet
 */
@WebServlet("/Math31Servlet")
public class Math31Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public Math31Servlet() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (a1 == 0 || b1 == 0) {
			...
			if (arr1 == null || arr2 == null) {
				...
				double[][] result = MathUtil.add(arr1, arr2);
				if (result == null) {
					String err = "请传入同型数据";
					mapper.writeValue(response.getWriter(), err);
				} else {
