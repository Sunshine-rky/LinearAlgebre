...
/**
 * Servlet implementation class ShowMyQuestionDetail
 */
@WebServlet("/ShowMyQuestionDetail")
public class ShowMyQuestionDetail extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowMyQuestionDetail() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dis=request.getRequestDispatcher("showMyQuestionDetail.jsp");
