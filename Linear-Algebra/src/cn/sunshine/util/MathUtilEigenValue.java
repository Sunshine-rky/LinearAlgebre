...
public class MathUtilEigenValue {
	 ...
	 ************
	 */
	//矩阵的特征值,根据线代书,传入的矩阵应为方阵
public static double[] getCharacteristicValue(double[][] arr) {
	double[][] arr1 = matrixEigValue(arr, 1000);
...
////		double[][] tempData = {{-1,1,0},{-4,4,0},{1,0,2}};
//		double[][] tempData = {{-2,1,1},{0,2,0},{-4,1,3}};
////		double[][] tempEigValue = matrixEigValue(tempData, 1000);
////		double[][] tempEigVector = matrixEigVector(tempData, 1000);
//		double[] tempEigValue=getCharacteristicValue(tempData);
//		System.out.println("The eig value is: " + Arrays.toString(tempEigValue));
