...
function displayResult(){
	...
	$.ajax({
		...
		data:{
			a:$("#textareaContents").val(),
			b:$("#textareaContents1").val()
			},//第一个textareaContents值文本框的Id，用jquery方式的AJAX提交，这个Id必须要
...
<body>
	...
	结果
	<textarea rows="20" cols="40" id="textareaContents1" name="b">
	</textarea>
	<button type="button" onclick="displayResult()">求方程组的解</button>
