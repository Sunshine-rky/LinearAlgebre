...
<div class="news-nav">
  <div class="container clearfix">
    <div class="nav-bar">
      ...
      <a href="#" class="ask_tips_box" target="_blank">我的提问    ${number}  </a>
		<a class="" href="FindAllMyAnswerServlet">我的回答</a>
		   </div>
...
<link href="css/qa3.css" media="screen" rel="stylesheet" />
  ...
  <dl>
    <h1>
      <a href="ShowMyQuestionDetail?resPath=${afile.q_title}" target="_blank">${afile.q_title}</a>
    </h1>
    <dd>
     ${afile.q_content}
    </dd>
